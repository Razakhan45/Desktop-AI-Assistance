...
__all__ = [
    'tagSPTEXTSELECTIONINFO', 'SVSFIsXML', 'SVSFPersistXML',
    'DISPID_SGRSTType', 'DISPID_SRCSetAdaptationData',
    '_SPAUDIOSTATE', 'SPWORDPRONUNCIATION', 'SPRECOCONTEXTSTATUS',
    'SVEPhoneme', 'DISPID_SRSCurrentStreamNumber',
    'SPDKL_DefaultLocation', 'SpeechVoiceEvents',
    'DISPID_SRGCmdLoadFromResource', 'SAFTCCITT_uLaw_11kHzMono',
    'DISPID_SVGetProfiles', 'SPEI_MIN_TTS', 'SPLEXICONTYPE',
    'STCRemoteServer', 'DISPID_SPAsItem',
    'DISPID_SGRSAddWordTransition', 'SPPHRASEELEMENT',
    'ISpRecognizer', 'SAFT16kHz16BitStereo', 'SPAUDIOSTATE',
    'SP_VISEME_9', 'IInternetSecurityMgrSite', 'SSSPTRelativeToEnd',
    'DISPID_SDKEnumKeys', 'DISPID_SpeechObjectTokenCategory',
    'SVF_Emphasis', 'UINT_PTR', 'SPSERIALIZEDPHRASE',
    'SpeechRegistryUserRoot', 'SpeechPropertyResponseSpeed',
    'DISPIDSPTSI_ActiveLength', 'DISPID_SGRSTsItem',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'SpeechSpecialTransitionType', 'SGSDisabled',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SPPNumberOfElements',
    'SPAUDIOSTATUS', 'SDKLLocalMachine', 'DISPID_SpeechVoiceEvent',
    'eLEXTYPE_PRIVATE18', 'SVEViseme', 'SPWORD', 'ISpeechObjectToken',
    'SPWT_LEXICAL', 'SPAR_Low', 'LONG_PTR', 'SPLO_STATIC',
    'SPEI_MAX_SR', 'ISpRecoCategory', 'DISPID_SRCEPhraseStart',
    'SRSEDone', 'SAFT11kHz8BitStereo', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SGRsAdd', 'DISPID_SPRs_NewEnum', 'DISPID_SGRsFindRule',
    'SPEVENT', 'DISPID_SMSSetData', 'SLOStatic', 'SPPHRASEPROPERTY',
    'eLEXTYPE_PRIVATE20', 'eLEXTYPE_LETTERTOSOUND',
    'Speech_Max_Pron_Length', 'DISPID_SASNonBlockingIO',
    'DISPID_SpeechPhraseBuilder', 'SpeechEngineConfidence',
    'SPPHRASERULE', 'SpeechRecognizerState', 'SVP_16',
    'SVSFParseAutodetect', 'DISPID_SLPType',
    'DISPID_SpeechXMLRecoResult', 'SPAUDIOOPTIONS', 'SVP_17',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPEI_SR_RETAINEDAUDIO',
    'DISPID_SpeechLexiconWord', 'SREPropertyNumChange',
    'SPPS_RESERVED3', 'SPBO_TIME_UNITS', 'SPSEMANTICERRORINFO',
    'SPEI_PROPERTY_STRING_CHANGE', 'ISpeechObjectTokenCategory',
    'DISPID_SDKGetBinaryValue', 'DISPID_SVIsUISupported',
    'SPFM_CREATE_ALWAYS', 'DISPID_SABIBufferSize', 'SPCONTEXTSTATE',
    'DISPID_SRRTLength', 'DISPID_SWFEChannels', 'SpResourceManager',
    'eLEXTYPE_PRIVATE17', 'DISPID_SDKDeleteKey', 'SRERequestUI',
    'SPSHORTCUTPAIRLIST', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SPEI_RECOGNITION', 'SPEI_SR_AUDIO_LEVEL', 'SVP_4', 'SRAONone',
    'DISPID_SpeechObjectTokens', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SVPAlert', 'DISPID_SPRFirstElement', 'SRATopLevel',
    'DISPID_SRCEFalseRecognition', 'SVP_5', 'SLTApp',
    'SVEEndInputStream', 'DISPIDSPTSI', 'SPRULESTATE',
    'SPSHORTCUTPAIR', 'DISPID_SGRInitialState', 'SpFileStream',
    'SVP_0', 'SpWaveFormatEx', 'DISPID_SPEDisplayText', 'SP_VISEME_4',
    'DISPID_SRGRules', 'SINoise', 'SASClosed', 'ISpeechMemoryStream',
    'ISpeechPhoneConverter', 'DISPID_SLPPhoneIds',
    'DISPID_SDKDeleteValue', 'DISPID_SPANumberOfElementsInResult',
    'SAFTADPCM_22kHzStereo', 'SVSFIsNotXML', 'SpeechDiscardType',
    'DISPID_SPISaveToMemory', 'SpLexicon',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SPRNumberOfElements',
    'eLEXTYPE_RESERVED4', 'DISPID_SpeechRecoResultTimes',
    'SpeechStreamFileMode', 'SVP_13',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPEI_RESERVED2',
    '_ISpeechRecoContextEvents', 'SPSMF_UPS', 'SAFTADPCM_44kHzMono',
    'SVP_6', 'SPEI_RECO_OTHER_CONTEXT', 'ISpPhraseAlt',
    'ISpeechAudio', 'SVPOver', 'SPVISEMES', 'eLEXTYPE_PRIVATE9',
    'ISpeechRecoResultDispatch', 'ISpLexicon',
    'ISpeechRecognizerStatus', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SMSALineId', 'SWPUnknownWordPronounceable',
    'ISpeechGrammarRuleStateTransitions', 'SPEI_REQUEST_UI',
    'SRSActive', 'DISPID_SVSpeak', 'SPFM_NUM_MODES',
    'DISPID_SRCCmdMaxAlternates', 'SPPS_Function',
    'SAFT11kHz16BitStereo', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SVGetAudioOutputs', 'DISPID_SOTCSetId',
    'SPINTERFERENCE_TOOFAST', 'SREPhraseStart', 'SPSTREAMFORMATTYPE',
    'SGDSActiveWithAutoPause', 'DISPID_SRRTStreamTime',
    'Speech_StreamPos_Asap', 'DISPID_SOTsCount', 'SPWT_PRONUNCIATION',
    'DISPID_SpeechFileStream', 'DISPID_SpeechPhraseElement',
    'SSFMOpenReadWrite', 'SPWT_DISPLAY', 'SPSHT_Unknown',
    'DISPID_SLPsItem', 'SPADAPTATIONRELEVANCE', 'SLODynamic',
    'SINoSignal', 'SPPS_RESERVED4', 'SPPS_Noun', 'tagSPPROPERTYINFO',
    'SVEAllEvents', 'ISpeechDataKey', 'SpeechEmulationCompareFlags',
    'SpeechCategoryAudioIn', 'SAFT24kHz8BitMono',
    'SAFTADPCM_11kHzMono', 'SVP_14', 'DISPID_SpeechRecognizer',
    'DISPID_SPIAudioStreamPosition', 'SP_VISEME_6',
    'SAFT48kHz16BitStereo', 'SRSEIsSpeaking', 'eLEXTYPE_RESERVED9',
    'DISPID_SpeechLexicon', 'DISPID_SGRSTText', 'ISpEventSink',
    'DISPID_SPRText', 'SPBO_AHEAD', 'eLEXTYPE_RESERVED7',
    'DISPID_SPELexicalForm', 'SVSFParseSapi',
    'DISPID_SRIsUISupported', 'ISpeechRecoContext',
    'DISPID_SRGetFormat', 'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'DISPID_SOTs_NewEnum', 'SAFT22kHz16BitMono', 'DISPID_SRCState',
    'SVF_Stressed', 'SPPROPERTYINFO', 'ISpNotifyTranslator',
    'SRTAutopause', 'DISPID_SOTDataKey', 'SAFT16kHz8BitStereo',
    'DISPID_SPPParent', 'DISPID_SVEWord', 'DISPID_SPCLangId',
    'SDTPronunciation', 'STSF_FlagCreate',
    'DISPID_SpeechPhraseReplacement', 'SpeechLoadOption',
    'SPEI_RESERVED6', 'DISPID_SPIAudioSizeTime', 'SPCT_SUB_DICTATION',
    'DISPID_SRGCommit', 'SpeechRecoEvents', 'SRSInactive',
    'SAFT48kHz8BitMono', 'SVSFIsFilename', 'SVSFUnusedFlags',
    'DISPID_SVRate', 'DISPID_SVPriority', 'SpMemoryStream',
    'SAFTADPCM_8kHzMono', 'DISPID_SpeechPhraseProperty',
    'DISPID_SRCEPropertyNumberChange', 'SP_VISEME_3',
    'DISPID_SGRSTPropertyName', 'SPRST_INACTIVE',
    'DISPID_SWFEAvgBytesPerSec', 'ISpeechAudioBufferInfo',
    '_RemotableHandle', 'SDKLCurrentConfig', 'DISPID_SVAudioOutput',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SAFGetWaveFormatEx',
    'DISPID_SDKEnumValues', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SVEEnginePrivate',
    'DISPID_SRGDictationSetState', 'DISPID_SpeechPhraseAlternate',
    'SpeechAudioFormatType', 'SAFTGSM610_11kHzMono', 'SPRS_ACTIVE',
    'ISpStreamFormat', 'DISPID_SRRAudioFormat', 'SAFT48kHz16BitMono',
    'SPAO_NONE', 'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SAFType',
    'DISPID_SPPChildren', 'SASPause', 'SP_VISEME_1', 'ISpVoice',
    'DISPID_SLWLangId', 'SRSActiveAlways', 'DISPIDSPTSI_ActiveOffset',
    'SPFM_CREATE', 'DISPID_SRSCurrentStreamPosition', 'SVP_7',
    'SPPS_Unknown', 'DISPID_SRRTimes', 'SRSInactiveWithPurge',
    'DISPID_SpeechPhraseRules', 'DISPID_SVSLastResult',
    'SpCustomStream', 'DISPID_SAStatus', 'DISPID_SRRSpeakAudio',
    'SP_VISEME_13', 'DISPID_SPERequiredConfidence',
    'DISPID_SVEBookmark', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SWFEFormatTag', 'ISpeechLexicon',
    'DISPID_SRGDictationLoad', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SAFT11kHz16BitMono', 'DISPID_SPCIdToPhone',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SVSpeakStream',
    'ISpGrammarBuilder', 'DISPID_SLPSymbolic',
    'DISPID_SpeechRecoContextEvents', 'SpeechVoiceSpeakFlags',
    'SPAS_CLOSED', 'eLEXTYPE_PRIVATE13', 'SPSERIALIZEDRESULT',
    'SVSFNLPSpeakPunc', 'DISPID_SpeechLexiconPronunciation',
    'SPAR_Medium', 'DISPID_SDKSetBinaryValue', 'DISPID_SLPsCount',
    'SPVPRI_OVER', 'DISPID_SCSBaseStream', 'SPVPRIORITY',
    'SpeechCategoryRecognizers', 'DISPID_SOTCategory',
    'DISPID_SPIEnginePrivateData', 'SREAdaptation',
    'ISpeechPhraseAlternate', 'SFTInput', 'DISPID_SPPName',
    'DISPID_SRStatus', 'ISpRecognizer2', 'eWORDTYPE_DELETED',
    'SGRSTTEpsilon', 'SPSInterjection', 'DISPID_SPAs_NewEnum',
    'eLEXTYPE_VENDORLEXICON', 'SP_VISEME_12',
    'DISPID_SGRSTPropertyId', 'SPFILEMODE', 'SPEI_VISEME',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SPRsCount', 'DISPIDSPRG',
    'DISPID_SVEAudioLevel', 'DISPID_SLWs_NewEnum',
    'DISPID_SRCERequestUI', 'DISPID_SVStatus', 'SWTAdded',
    'SRTEmulated', 'DISPID_SPIGrammarId', 'SREBookmark',
    'DISPID_SWFEBlockAlign', 'DISPID_SWFEExtraData',
    'SpeechAddRemoveWord', 'DISPID_SVSRunningState',
    'SAFTExtendedAudioFormat', 'SSSPTRelativeToStart', 'SVP_18',
    'SpeechGrammarTagDictation', 'STCInprocServer',
    'DISPID_SRRTTickCount', 'ISpeechAudioStatus', 'SVF_None',
    'DISPID_SGRsCount', 'DISPID_SRSetPropertyNumber',
    'SPGRAMMARSTATE', 'SpeechPropertyComplexResponseSpeed',
    'SpMMAudioIn', 'SRTStandard', 'DISPID_SRRSetTextFeedback',
    'SECFIgnoreCase', 'SpeechBookmarkOptions',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SPPsItem',
    'DISPID_SDKSetStringValue', 'ISpObjectWithToken',
    'DISPID_SLPs_NewEnum', 'Speech_Default_Weight', 'SGDSActive',
    'eLEXTYPE_PRIVATE6', 'DISPID_SPACommit', 'SDTAlternates',
    'SPEI_START_SR_STREAM', 'eLEXTYPE_PRIVATE12',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SRRecognizer',
    'SpeechAudioState', 'SPINTERFERENCE_TOOLOUD', 'SGDSInactive',
    'DISPID_SpeechMemoryStream', 'SAFTADPCM_22kHzMono',
    'STCInprocHandler', 'DISPID_SASFreeBufferSpace', 'SVP_19',
    'SVP_11', 'SREAllEvents', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SOTGetAttribute', 'SVPNormal', 'ISpeechRecoResultTimes',
    'SpVoice', 'SPEI_FALSE_RECOGNITION', 'ISpeechBaseStream',
    'SpeechPropertyLowConfidenceThreshold', 'SPSVerb', 'SRAImport',
    'SGRSTTRule', 'DISPID_SpeechRecoContext', 'ISpPhrase',
    'DISPID_SASCurrentDevicePosition', 'SPEI_MIN_SR',
    'ISpeechAudioFormat', 'SpeechCategoryAudioOut',
    'SpeechCategoryAppLexicons', 'DISPID_SPEDisplayAttributes',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SPERetainedSizeBytes',
    'DISPID_SRGCmdLoadFromMemory', 'SPSLMA', 'SPCATEGORYTYPE',
    'SPWORDLIST', 'SAFT16kHz16BitMono', 'DISPID_SRRPhraseInfo',
    'SAFTADPCM_44kHzStereo', 'ISpNotifySink',
    'DISPID_SRCEEnginePrivate', 'SPSUnknown', 'SPEI_RESERVED5',
    'SVP_12', 'ISpeechFileStream', 'SAFT32kHz8BitMono',
    'SPDKL_LocalMachine', 'ISpeechGrammarRule', 'SGRSTTWildcard',
    'eLEXTYPE_USER', 'eLEXTYPE_PRIVATE2', 'SpeechRecoContextState',
    'SP_VISEME_0', 'eLEXTYPE_RESERVED8', 'SITooLoud',
    'SAFTCCITT_uLaw_8kHzMono', 'ISpeechXMLRecoResult',
    'DISPID_SLWWord', 'SPCT_DICTATION', 'SWTDeleted',
    'SPTEXTSELECTIONINFO', 'SPWORDPRONOUNCEABLE', 'SPPS_LMA',
    'DISPID_SGRSTsCount', 'DISPID_SLWType', 'SPEI_WORD_BOUNDARY',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SpeechAudioFormatGUIDText',
    'DISPID_SGRSRule', 'DISPID_SRGReset', 'SVSFlagsAsync',
    'DISPID_SMSADeviceId', 'SpeechAudioFormatGUIDWave',
    'SVSFParseSsml', 'SSFMOpenForRead', 'SBONone',
    'DISPID_SRSAudioStatus', 'DISPID_SGRsItem', 'SPEI_HYPOTHESIS',
    'SPSEMANTICFORMAT', 'DISPID_SREmulateRecognition',
    'DISPID_SRCVoice', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SRCResume', 'DISPID_SAEventHandle', 'ISpResourceManager',
    'SP_VISEME_5', 'SpInprocRecognizer',
    'DISPID_SpeechPhoneConverter', 'eLEXTYPE_RESERVED6',
    'DISPID_SPILanguageId', 'SPRST_ACTIVE_ALWAYS',
    'ISpeechPhraseReplacement', 'SRTExtendableParse',
    'SAFT8kHz8BitStereo', 'SAFT12kHz8BitMono', 'DISPID_SAVolume',
    'SAFTCCITT_uLaw_22kHzMono', 'SpPhoneConverter',
    'SpeechAudioVolume', 'SRESoundEnd', 'DISPID_SBSFormat',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SRCESoundEnd',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SGRSAddRuleTransition',
    'SVP_9', 'DISPID_SPIAudioSizeBytes', 'SAFT48kHz8BitStereo',
    'DISPID_SPAPhraseInfo', 'ISpeechPhraseProperty',
    'SpeechFormatType', 'ISpNotifySource', 'tagSTATSTG',
    'DISPID_SLGetWords', 'DISPID_SpeechGrammarRule',
    'DISPID_SPIReplacements', 'SPEI_START_INPUT_STREAM',
    'SGRSTTDictation', 'DISPID_SRSClsidEngine', 'SGPronounciation',
    'DISPID_SVEPhoneme', 'SPRST_INACTIVE_WITH_PURGE',
    'ISpeechPhraseInfoBuilder', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SpeechAudio', 'SPAR_High', 'SECHighConfidence',
    'SPFM_OPEN_READWRITE', 'SAFTGSM610_44kHzMono',
    'DISPID_SADefaultFormat', 'SpShortcut', 'SPXRO_Alternates_SML',
    'DISPID_SMSAMMHandle', 'DISPID_SRGIsPronounceable',
    'ISpeechRecognizer', 'SpInProcRecoContext', 'DISPID_SVEViseme',
    'SPEVENTSOURCEINFO', 'ISpRecoGrammar2', 'SDA_One_Trailing_Space',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SpeechGrammarRuleState',
    'ISpRecoResult', 'DISPID_SVSInputSentencePosition',
    'SPEI_SOUND_END', 'SPCT_SLEEP', 'SPPS_SuppressWord',
    'SVESentenceBoundary', 'SPEI_VOICE_CHANGE',
    'DISPID_SRRSaveToMemory', 'SpeechMicTraining',
    'SpeechEngineProperties', 'DISPID_SPPId',
    'ISpStreamFormatConverter', 'SRAORetainAudio', 'SITooQuiet',
    'SPSNoun', 'SpeechTokenKeyAttributes', 'SpNullPhoneConverter',
    'SVEAudioLevel', 'SpeechVisemeFeature',
    'SpPhoneticAlphabetConverter', 'DISPID_SRCBookmark',
    'DISPID_SLGenerationId', 'DISPID_SPIEngineId',
    'DISPID_SpeechDataKey', 'DISPID_SAFGuid', 'DISPID_SPEs_NewEnum',
    'DISPID_SRCPause', 'DISPID_SpeechRecoResult', 'SPEI_MAX_TTS',
    'SRCS_Enabled', 'SPCT_COMMAND', 'DISPID_SRCEAudioLevel',
    'DISPID_SVSLastStreamNumberQueued', 'DISPID_SPRuleConfidence',
    'STCLocalServer', 'DISPID_SGRSTPropertyValue', 'SPWF_SRENGINE',
    'SREAudioLevel', 'SpeechRetainedAudioOptions',
    'SpeechTokenContext', 'SP_VISEME_10', 'DISPID_SPIGetText',
    'ISpMMSysAudio', 'SPDATAKEYLOCATION', 'DISPID_SpeechVoice',
    'SPSHORTCUTTYPE', 'SPRECOGNIZERSTATUS',
    'ISpeechLexiconPronunciations', 'IEnumSpObjectTokens',
    'DISPID_SPPValue', 'SpObjectTokenCategory', 'DISPID_SVGetVoices',
    'SP_VISEME_19', 'ISpeechGrammarRuleStateTransition', 'SVP_2',
    'DISPID_SDKCreateKey', 'SVP_21', 'DISPID_SOTCDefault',
    'SAFT44kHz8BitStereo', 'ISpeechPhraseRule',
    'ISpeechLexiconPronunciation', 'DISPID_SOTId',
    'DISPID_SRCERecognitionForOtherContext', 'SAFTGSM610_8kHzMono',
    'DISPID_SASState', 'DISPID_SpeechPhraseProperties',
    'DISPID_SGRsCommit', 'SASStop', 'DISPID_SRCEBookmark',
    'DISPID_SOTIsUISupported', 'DISPID_SPRuleId', 'SPSModifier',
    'SPVPRI_ALERT', 'DISPID_SRCAudioInInterferenceStatus',
    'SpeechAllElements', 'DISPID_SVESentenceBoundary',
    'SWPKnownWordPronounceable', 'SAFTADPCM_11kHzStereo',
    'SpeechVisemeType', 'SDTAudio', 'DISPID_SRRAlternates',
    'DISPID_SRDisplayUI', '__MIDL_IWinTypes_0009', 'SECFIgnoreWidth',
    'SPEI_PHRASE_START', 'SpeechDictationTopicSpelling',
    'DISPID_SRCERecognition', 'DISPID_SpeechAudioFormat', 'SVP_20',
    '_ISpeechVoiceEvents', 'DISPID_SRSNumberOfActiveRules',
    'SpeechWordType', 'SITooFast', 'SAFTCCITT_ALaw_11kHzMono',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SPRuleChildren',
    'SPBOOKMARKOPTIONS', 'SPVOICESTATUS', 'SVP_15', 'SAFTText',
    'DISPID_SVEStreamStart', 'DISPID_SRCEEndStream',
    'DISPID_SABIMinNotification', 'DISPID_SpeechGrammarRules',
    'SPDKL_CurrentConfig', 'ISpeechVoiceStatus',
    'SGDSActiveUserDelimited', 'SpeechRunState', 'SVSFDefault',
    'SDTRule', 'DISPID_SLRemovePronunciation', 'ISpRecoGrammar',
    'DISPID_SOTSetId', 'SAFT24kHz8BitStereo',
    'ISpObjectTokenCategory', 'DISPID_SPRuleNumberOfElements',
    'SRAExport', 'SRADynamic', 'DISPID_SLAddPronunciationByPhoneIds',
    'SAFT8kHz16BitStereo', 'DISPID_SRRAudio', 'ISpRecoContext',
    'SAFT12kHz16BitStereo', 'DISPID_SPEEngineConfidence',
    'SpCompressedLexicon', 'SSSPTRelativeToCurrentPosition',
    'SGRSTTTextBuffer', 'SAFT11kHz8BitMono', 'SpMMAudioOut',
    'SAFT24kHz16BitStereo', 'DISPID_SGRSTWeight',
    'SpPhraseInfoBuilder', 'DISPID_SVSVisemeId',
    'ISpeechGrammarRules', 'SAFT8kHz16BitMono',
    'SpeechGrammarWordType', 'ISpeechMMSysAudio',
    'SVEStartInputStream', 'SINone', 'SPEI_SR_PRIVATE',
    'SGLexicalNoSpecialChars', 'SpeechVoiceSkipTypeSentence',
    'DISPID_SVDisplayUI', 'SAFT22kHz8BitMono', 'SPEI_RESERVED1',
    'SASRun', 'SDTProperty', 'SFTSREngine',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SP_VISEME_8',
    'ISpeechTextSelectionInformation', 'DISPID_SRRDiscardResultInfo',
    'SPEI_ADAPTATION', 'DISPID_SpeechLexiconWords',
    'DISPID_SRProfile', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SAFTADPCM_8kHzStereo', 'eLEXTYPE_PRIVATE10',
    'DISPID_SPIProperties', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SDKGetlongValue', 'SRESoundStart', 'eLEXTYPE_APP',
    'SPCS_ENABLED', 'DISPID_SVSInputSentenceLength', 'IEnumString',
    'SPCS_DISABLED', 'SVP_3', 'SpeechCategoryPhoneConverters',
    'SPEI_PHONEME', 'DISPID_SPCPhoneToId', 'DISPID_SVSkip',
    'DISPID_SVPause', 'SpSharedRecognizer', 'DISPID_SRCEHypothesis',
    'eWORDTYPE_ADDED', 'SpeechStreamSeekPositionType',
    'DISPID_SLPPartOfSpeech', 'DISPID_SPPs_NewEnum',
    'eLEXTYPE_PRIVATE16', 'DISPID_SRGRecoContext', 'SREHypothesis',
    'DISPID_SRState', 'SPXRO_SML', 'SSFMCreateForWrite',
    'SpeechVoicePriority', 'SpeechDataKeyLocation',
    'SECNormalConfidence', 'SECFDefault', 'SDTLexicalForm',
    'SPSNotOverriden', 'SpeechInterference', 'SP_VISEME_18',
    'DISPID_SBSSeek', 'IStream', 'SAFT22kHz16BitStereo',
    'DISPID_SVSLastBookmarkId', 'DISPID_SFSOpen', 'SRCS_Disabled',
    'ISpeechGrammarRuleState', 'SPEI_RECO_STATE_CHANGE', 'ISpStream',
    'eLEXTYPE_PRIVATE3', 'SpeechPropertyAdaptationOn', 'SPSHT_EMAIL',
    'SpeechPropertyResourceUsage', 'SPGS_ENABLED', 'SPAS_RUN',
    'SPEI_UNDEFINED', 'SpAudioFormat', 'IInternetSecurityManager',
    'DISPID_SPRulesItem', 'SP_VISEME_14', 'DISPID_SRCEInterference',
    'SAFTNoAssignedFormat', 'ISpXMLRecoResult', 'SDTDisplayText',
    'DISPID_SRCCreateGrammar', 'SpSharedRecoContext', 'DISPID_SGRId',
    'DISPID_SPEsItem', 'DISPID_SpeechPhraseAlternates',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SRGetRecognizers',
    'SREPrivate', 'DISPID_SVVolume', 'DISPID_SpeechMMSysAudio',
    'DISPID_SRCESoundStart', 'Speech_Max_Word_Length',
    'ISpEventSource', 'SPINTERFERENCE_NONE', 'SPEI_SOUND_START',
    'SpeechVoiceCategoryTTSRate', 'SPWORDTYPE',
    'DISPID_SOTGetDescription', 'SPGS_EXCLUSIVE', 'SPRULE',
    'SAFTCCITT_ALaw_44kHzMono', 'SAFT44kHz16BitMono',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SPPEngineConfidence',
    'DISPID_SRRTOffsetFromStart', 'SGSExclusive', 'SPPS_Modifier',
    'SPRST_NUM_STATES', 'ISpeechPhraseProperties', 'ISpeechVoice',
    'ISpPhoneticAlphabetSelection', 'DISPID_SDKOpenKey',
    'DISPID_SVGetAudioInputs', 'SREFalseRecognition',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SpeechRecoResult2',
    'DISPID_SRGId', 'SVEBookmark', 'DISPID_SRRGetXMLErrorInfo',
    'eLEXTYPE_MORPHOLOGY', 'SpeechGrammarTagUnlimitedDictation',
    'SpNotifyTranslator', 'SECFEmulateResult',
    'DISPID_SRGetPropertyNumber', 'SpStreamFormatConverter',
    'ISpeechRecoResult', 'SPXMLRESULTOPTIONS', 'ISpPhoneConverter',
    'SPINTERFERENCE_LATENCY_WARNING', 'SpeechPartOfSpeech',
    'DISPID_SABufferInfo', 'eLEXTYPE_PRIVATE11', 'DISPID_SPEsCount',
    'SPPARTOFSPEECH', 'SDA_Two_Trailing_Spaces', 'SVSFNLPMask',
    'SPEI_TTS_AUDIO_LEVEL', 'SPRS_INACTIVE',
    'DISPID_SpeechBaseStream', 'SAFT32kHz16BitStereo',
    'DISPID_SPEActualConfidence', 'SSTTTextBuffer',
    ...
    'DISPID_SGRSTRule', 'DISPID_SVWaitUntilDone', 'DISPID_SBSRead',
    'SAFTNonStandardFormat', 'SAFT22kHz8BitStereo', 'SITooSlow',
    'SREPropertyStringChange', 'SPGRAMMARWORDTYPE', 'SRAInterpreter',
    'DISPID_SPPsCount', 'SpeechRuleAttributes', 'SAFT32kHz16BitMono',
    'eLEXTYPE_PRIVATE15', 'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SLWPronunciations',
    'DISPID_SLGetPronunciations', 'DISPID_SRCEAdaptation',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'DISPID_SGRSTransitions',
    'SVEPrivate', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SRRRecoContext', 'SAFT44kHz16BitStereo',
    'DISPID_SGRClear', 'ISpeechLexiconWords', 'SPAR_Unknown',
    'SAFT24kHz16BitMono', 'DISPID_SWFESamplesPerSec',
    'DISPID_SPRuleName', 'DISPID_SMSGetData',
    'DISPID_SRAudioInputStream', 'Speech_StreamPos_RealTime',
    'DISPID_SLWsItem', 'ISpeechPhraseReplacements',
    'ISpeechPhraseInfo', 'DISPID_SRGDictationUnload',
    'DISPID_SPERetainedStreamOffset', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SpeechLexiconType', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SRIsShared', 'DISPID_SRSSupportedLanguages',
    'SDA_Consume_Leading_Spaces', 'SREStreamStart',
    'SECLowConfidence', 'SP_VISEME_21', 'ISpDataKey',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SLWsCount',
    'DISPID_SpeechWaveFormatEx', 'STSF_LocalAppData', 'WAVEFORMATEX',
    'DISPID_SRCEventInterests', 'SAFTDefault', 'SpeechGrammarState',
    'SPRECOSTATE', 'SpeechTokenValueCLSID', 'DISPID_SPARecoResult',
    'STSF_CommonAppData', 'SPEI_TTS_BOOKMARK', 'DISPID_SPIRule',
    'SPEI_END_SR_STREAM', 'SP_VISEME_2', 'DISPID_SPRules_NewEnum',
    'DISPID_SGRName', 'eLEXTYPE_RESERVED10', 'ISpeechPhraseElement',
    'DISPID_SpeechLexiconProns', 'SPAS_STOP', 'SSFMCreate',
    'SpeechRuleState', 'SAFTGSM610_22kHzMono',
    'SPINTERFERENCE_TOOQUIET', 'SPINTERFERENCE_TOOSLOW',
    'SRERecoOtherContext', 'DISPID_SpeechPhraseElements',
    'SPEI_RESERVED3', 'ISpRecognizer3', 'ISpeechWaveFormatEx',
    'eLEXTYPE_PRIVATE8', 'SGRSTTWord', 'DISPID_SWFEBitsPerSample',
    'SVSFParseMask', 'DISPID_SRAudioInput', 'SpeechTokenKeyUI',
    'SAFT44kHz8BitMono', 'SpUnCompressedLexicon',
    'eLEXTYPE_PRIVATE14', 'SpeechCategoryRecoProfiles',
    'SAFTCCITT_uLaw_44kHzMono', 'SPEI_INTERFERENCE',
    'SPEI_TTS_PRIVATE', 'SVSFVoiceMask', 'SGDisplay',
    'DISPID_SOTRemove', 'eLEXTYPE_PRIVATE7', 'eLEXTYPE_PRIVATE4',
    'SpObjectToken', 'DISPID_SPIStartTime', 'SPEI_SR_BOOKMARK',
    'DISPID_SRCreateRecoContext', 'DISPID_SPRDisplayAttributes',
    'DISPID_SpeechCustomStream', 'SpTextSelectionInformation',
    'SPPS_NotOverriden', 'eLEXTYPE_PRIVATE19',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'DISPID_SOTCId',
    'DISPID_SGRsDynamic', 'SPGS_DISABLED', 'ISpeechPhraseRules',
    'DISPID_SRCERecognizerStateChange', 'DISPID_SOTCGetDataKey',
    'DISPID_SRSetPropertyString',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SVSInputWordLength', 'SAFT32kHz8BitStereo',
    'SSTTDictation', 'SAFT16kHz8BitMono', 'DISPID_SGRs_NewEnum',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'DISPID_SPRuleEngineConfidence', 'ISpeechRecoGrammar',
    'ISpeechResourceLoader', 'SPFM_OPEN_READONLY', 'SRARoot',
    'SPEVENTENUM', 'DISPID_SDKSetLongValue',
    'DISPID_SPIGetDisplayAttributes', 'SPPS_Noncontent',
    'eLEXTYPE_PRIVATE5', 'SPAS_PAUSE', 'DISPID_SOTCreateInstance',
    'DISPID_SPRuleFirstElement', 'DISPID_SPPFirstElement',
    'SpeechTokenIdUserLexicon', 'SVP_1',
    'DISPID_SVSInputWordPosition', 'SAFT12kHz16BitMono', 'SRTReSent',
    'SP_VISEME_20', 'DISPID_SRGState', 'SBOPause',
    'DISPID_SOTDisplayUI', 'DISPID_SVEventInterests',
    'DISPID_SLPLangId', 'SpMMAudioEnum', 'DISPID_SRRGetXMLResult',
    'SWPUnknownWordUnpronounceable', 'SPINTERFERENCE',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SVP_8', 'ISpeechLexiconWord',
    'SpeechTokenKeyFiles', 'SRERecognition', 'SpeechTokenShellFolder',
    'DISPID_SVAudioOutputStream', 'DISPID_SpeechPhraseRule',
    'DISPID_SVEVoiceChange', 'SECFNoSpecialChars', 'SPRST_ACTIVE',
    'SREStreamEnd', 'DISPID_SRCRetainedAudio', 'SDTAll',
    'DISPID_SVSCurrentStreamNumber', 'DISPIDSPTSI_SelectionOffset',
    'DISPID_SRCCreateResultFromMemory', 'SPLOADOPTIONS',
    'SECFIgnoreKanaType', 'SPRECORESULTTIMES', 'SRADefaultToActive',
    'SPCT_SUB_COMMAND', 'DISPID_SPEAudioSizeTime',
    'DISPID_SPRuleParent', 'ISequentialStream', 'SpStream',
    'DISPID_SRCRequestedUIType', 'DISPID_SRGSetWordSequenceData',
    'SRTSMLTimeout', 'SPPS_RESERVED2', 'DISPID_SRCEStartStream',
    'DISPID_SGRAddResource', 'DISPID_SGRSTNextState',
    'DISPID_SOTsItem', 'SPINTERFERENCE_NOISE', 'DISPID_SVSPhonemeId',
    'DISPID_SVResume', 'SpeechRegistryLocalMachineRoot',
    'DISPID_SGRAttributes', 'SPBO_PAUSE', 'SLTUser',
    'SPAO_RETAIN_AUDIO', 'SPSHT_OTHER', 'ISpeechPhraseElements',
    'SVSFPurgeBeforeSpeak', 'SSTTWildcard', 'ISpAudio',
    'DISPID_SABufferNotifySize', 'DISPID_SpeechAudioStatus',
    'ISpRecoContext2', 'DISPID_SPAStartElementInResult',
    'DISPID_SOTGetStorageFileName', 'eLEXTYPE_PRIVATE1',
    'DISPID_SPAsCount', 'SpeechPropertyHighConfidenceThreshold',
    'SP_VISEME_16', 'SpeechGrammarRuleStateTransitionType', 'SVP_10',
    'DISPID_SPPConfidence', 'SGSEnabled', 'SPVPRI_NORMAL',
    'DISPID_SLGetGenerationChange', 'SDKLDefaultLocation',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SPEPronunciation',
    'DISPID_SVEStreamEnd', 'DISPID_SVVoice', 'ISpProperties',
    'SPAUDIOBUFFERINFO', 'DISPID_SpeechPhraseInfo', 'SDKLCurrentUser',
    'SAFTCCITT_ALaw_44kHzStereo', 'SAFT12kHz8BitStereo',
    'DISPID_SRCEPropertyStringChange', 'DISPID_SGRSTs_NewEnum',
    'SPSHT_NotOverriden', 'DISPID_SLAddPronunciation',
    'SpeechCategoryVoices', 'SpeechRecoProfileProperties',
    'SVEVoiceChange', 'SPPHRASE', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SASetState', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SABIEventBias', 'SpeechPropertyNormalConfidenceThreshold',
    'ISpeechCustomStream', 'SPWF_INPUT', 'SPSFunction',
    'DISPID_SPRulesCount', 'DISPID_SVAlertBoundary',
    'SAFTCCITT_ALaw_11kHzStereo', 'SDTReplacement', 'SVEWordBoundary',
    'DISPID_SBSWrite', 'SPPS_Interjection', 'STCAll',
    'SpeechWordPronounceable', 'SDA_No_Trailing_Space',
    'DISPIDSPTSI_SelectionLength', 'SPEI_END_INPUT_STREAM',
    'SpeechDisplayAttributes', 'ISpeechPhraseAlternates',
    'DISPID_SVSLastBookmark', 'SpeechGrammarTagWildcard',
    'SREStateChange', 'ISpShortcut', 'SP_VISEME_7', 'SPLO_DYNAMIC',
    'SpeechUserTraining', 'DISPID_SPIElements', 'SPPS_Verb',
    'DISPID_SGRsCommitAndSave',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPWAVEFORMATTYPE', 'STSF_AppData', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SREInterference', 'SP_VISEME_15', 'SpeechRecognitionType',
    'SAFTCCITT_ALaw_8kHzStereo', 'SGLexical', 'SPPHRASEREPLACEMENT',
    'SPDKL_CurrentUser', 'DISPID_SpeechVoiceStatus',
    'DISPID_SRCRecognizer', 'SPBO_NONE', 'ISpeechObjectTokens',
    'DISPID_SPRsItem', 'DISPID_SpeechObjectToken', 'ISpObjectToken',
    'DISPID_SASCurrentSeekPosition', 'DISPID_SRGetPropertyString',
    'DISPID_SOTMatchesAttributes', 'ISpSerializeState',
    'SPBINARYGRAMMAR', 'DISPID_SFSClose', 'SP_VISEME_17',
    'SPSSuppressWord', 'SP_VISEME_11', 'DISPID_SDKGetStringValue',
    'SpeechAudioProperties', 'SAFTCCITT_ALaw_22kHzMono',
    'ISpeechRecoResult2', 'SPPS_RESERVED1', 'DISPID_SGRAddState'
]

_check_version('1.2.0', 1700889753.921923)
